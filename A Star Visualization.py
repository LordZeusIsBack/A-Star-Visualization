...
class Spot:
    def __init__(self, row, col, width, total_rows):
        self.row, self.col, self.x, self.width = row, col, row * width, width
        self.y, self.color, self.neighbours, self.total_rows = col * width, WHITE, [], total_rows
...
def main(win, width):
    ...
    start, end, run, started = None, None, True, False
    while run:
        ...
        for event in pygame.event.get():
            ...
            if pygame.mouse.get_pressed()[0]:
                ...
                try:
                    ...
                    elif spot != start and spot != end: spot.make_barrier()
